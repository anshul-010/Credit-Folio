...
const Offers = () => {
  return (
    ...
    <HStack display='flex' justifyContent='center' flexWrap='wrap' gap='2rem 4rem' p='1rem 2rem' w='fit-content' m='2rem auto' bg='#eee' borderRadius='4px'>
     ...
     <Stack borderRadius='6px' bg='#0094e9c2' w='fit-content' border='solid 1px #ccc' p='4px' >
        ...
        <Box  textAlign='center' color='#fff'>1</Box>
     </Stack>
    
     <Stack borderRadius='6px' bg='#999999c2' w='fit-content' border='solid 1px #ccc' p='4px' >
        <Box textAlign='center' bg='#fff' p='10px 18px 4px 18px'>
        <img className='icon' src={personal} alt="" />
        <Text as='p' fontSize='13px' >Credit</Text>
        <Text as='p' fontSize='13px' >Cards</Text>
        </Box>
        <Box textAlign='center' color='#fff'>0</Box>
     </Stack>
     ...
     <Stack borderRadius='6px' bg='#0094e9c2' w='fit-content' border='solid 1px #ccc' p='4px' >
        ...
        <Box  textAlign='center' color='#fff'>2</Box>
     </Stack>
